...
- **FC155 interface**: what DB/tags hold Setpoint and Actual Value today,
  and what data type (INT, REAL, scaled integer)? Does FC155 already exist
...
- **Glue scale hardware specifics**: which analog input address, raw
  ...
  use? All placeholders in the FC155 draft right now.
